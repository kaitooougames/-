...
public class Player4 : MonoBehaviour
{
    ...
    public void ApplyPenalty()
    {
        ...
        else // すでに前科ありなら行動カードを没収
        {
            ...
            if (player4Cards.Count == 1 && player4Cards[0].IsCageCard())
            {
    ...
    private void RemoveRandomPlayerCard()
    {
        ...
        // ランダムに1枚削除
        CardInteraction cardToRemove = player4Cards[Random.Range(0, player4Cards.Count)];
    ...
    private void ShowPenaltyCard()
    {
        if (isFirstOffense && arrestPenaltyCardPrefab != null)
        {
            ...
            Quaternion spawnRotation = Quaternion.Euler(0f, 90f, 0f); // 🔹 90度回転
